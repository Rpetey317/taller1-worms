...
public:
    Skier() {
        b2Body* ground = NULL;
        {
            ...
            Second angle is relative to the preceding slope, and should be positive, creating a kind
            of loose 'Z'-shape from the 3 edges. If A1 = -10, then A2 <= ~1.5 will result in the
            collision glitch. If A1 = -30, then A2 <= ~10.0 will result in the glitch.
            */
            ...
            */
            ...
            b2Vec2 v4(v3.x + SlopeLength * cosf(Slope2Incline),
                      v3.y - SlopeLength * sinf(Slope2Incline));
